## We represent a deck as a sequence. Despite the O(n) deletion of first element,
## for some reason, using a deque is less efficient.
...
proc play2(decks: var Decks): int =
  ## Play, using second rules, and return the winner.
